const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GameScene-C5b_pSUk.js","assets/index-BV6NC4OE.js","assets/index-BoWFO2X5.css"])))=>i.map(i=>d[i]);
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
function useMutation(options, queryClient) {
  ...
  const mutate = reactExports.useCallback(
    (variables, mutateOptions) => {
      observer2.mutate(variables, mutateOptions).catch(noop$1);
    },
    [observer2]
  );
...
class NativeAnimation extends WithPromise {
  ...
  commitStyles() {
    ...
    if (!this.isPseudoElement && (element == null ? void 0 : element.isConnected)) {
      (_c = (_b2 = this.animation).commitStyles) == null ? void 0 : _c.call(_b2);
    }
  }
  get duration() {
    var _a2, _b2;
...
Service({
  ...
  "getTotalGames": Func([], [Nat], ["query"]),
  "saveScore": Func([Text, Nat], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  return IDL2.Service({
    ...
    "getTotalGames": IDL2.Func([], [IDL2.Nat], ["query"]),
    "saveScore": IDL2.Func([IDL2.Text, IDL2.Nat], [], [])
  });
};
class Backend {
...
const INVINCIBILITY_DURATION_MS = 5e3;
const initialPlayer = {
  lane: 0,
  isJumping: false,
  isSliding: false,
...
const useGameStore = create((set, get) => ({
  ...
  collectCoin: (id2) => {
    set((state) => ({
      ...
      activeCoins: state.activeCoins.map(
        (c) => c.id === id2 ? { ...c, collected: true } : c
      )
    }));
  },
  collectShield: (id2) => {
    ...
    set((state) => ({
      ...
      activeShields: state.activeShields.map(
        (s) => s.id === id2 ? { ...s, collected: true } : s
      ),
      player: {
        ...state.player,
        isInvincible: true,
        invincibleUntil: now2 + INVINCIBILITY_DURATION_MS
      }
    }));
  },
  tickInvincibility: () => {
  ...
  setCoins: (coins) => set({ activeCoins: coins }),
  setShields: (shields) => set({ activeShields: shields }),
  setPlayer: (partial) => set((state) => ({ player: { ...state.player, ...partial } })),
  addDistance: (delta) => {
    set((state) => {
...
function StatTile({ icon, label, value, highlight }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: highlight ? "linear-gradient(135deg, oklch(0.65 0.18 45 / 0.12), oklch(0.55 0.22 35 / 0.08))" : "oklch(0.95 0.02 75)",
        border: highlight ? "1.5px solid oklch(0.65 0.18 45 / 0.35)" : "1.5px solid oklch(0.88 0.03 75)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl leading-none", children: icon }),
...
function LeaderRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: {
        background: isMe ? "oklch(0.62 0.24 142 / 0.12)" : rank <= 3 ? "oklch(0.65 0.18 45 / 0.07)" : "transparent",
        border: isMe ? "1.5px solid oklch(0.62 0.24 142 / 0.30)" : "1.5px solid transparent"
      },
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: Number(entry.score).toLocaleString()
          }
        )
      ]
    }
...
function GameOver() {
  ...
  const playerNameRef = reactExports.useRef(playerName);
  const scoreRef = reactExports.useRef(score);
  const saveScoreRef = reactExports.useRef(saveScore);
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  ...
                  children: isNewHighScore ? "New High Score!" : "Game Over"
                }
              ),
              isNewHighScore && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "font-body text-sm font-semibold",
                  style: { color: "oklch(0.55 0.20 142)" },
                  children: "You smashed the record! 🎉"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 grid grid-cols-2 gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { icon: "🪙", label: "Coins", value: coins.toString() }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { icon: "⏱️", label: "Time", value: `${timeSurvived}s` }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { icon: "🏅", label: "Best", value: highScore.toLocaleString() })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex flex-col gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, oklch(0.65 0.18 45), oklch(0.55 0.22 35))",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6", "data-ocid": "gameover.leaderboard", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: isLoadingScores ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "flex flex-col gap-2 p-2",
                      "data-ocid": "gameover.leaderboard_loading",
                      children: SKELETON_KEYS.map((k, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                    ...
                    "div",
                    {
                      ...
                      children: highScores.slice(0, 10).map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            LeaderRow,
                            {
                              entry,
                              rank: i + 1,
                              isMe: entry.playerName === playerName && Number(entry.score) === score
                            }
                          )
                        },
                        `${entry.playerName}_${String(entry.score)}`
                      ))
                    }
                  )
                }
...
function StatPill({ icon, value, label, ocid, accent, glow }) {
  const glowStyle = glow === "cyan" ? {
    background: "oklch(0.25 0.12 210 / 0.90)",
    border: "1.5px solid oklch(0.78 0.18 210 / 0.70)",
    boxShadow: "0 0 14px oklch(0.78 0.18 210 / 0.55), 0 4px 14px oklch(0 0 0 / 0.22)"
  } : accent ? {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                color: glow === "cyan" ? "oklch(0.75 0.10 210)" : accent ? "oklch(0.88 0.08 142)" : "oklch(0.75 0.03 75)"
              },
              children: label
            }
          )
...
function ShieldBadge({
  ...
  const remaining = Math.max(
    0,
    Math.ceil((invincibleUntil - Date.now()) / 1e3)
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: {
        ...
        boxShadow: "0 0 20px oklch(0.75 0.18 210 / 0.65), 0 4px 14px oklch(0 0 0 / 0.22)",
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                style: {
                  background: clamped < 50 ? "oklch(0.72 0.20 142)" : clamped < 80 ? "oklch(0.72 0.18 65)" : "oklch(0.65 0.22 25)"
                },
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isInvincible && /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldBadge, { invincibleUntil }, "shield-badge") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatPill,
            {
              icon: "🛡️",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(SpeedBar, { speed })
        ] })
      ]
    }
  );
...
function StartScreen() {
  ...
  const [name, setName] = reactExports.useState(playerName);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: {
        background: "linear-gradient(160deg, oklch(0.97 0.06 75) 0%, oklch(0.93 0.08 60) 50%, oklch(0.88 0.10 45) 100%)"
      },
      initial: { opacity: 0 },
      animate: { opacity: 1 },
      exit: { opacity: 0 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 overflow-hidden", children: HOUSE_EMOJIS.map((emoji, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            style: {
              ...
              boxShadow: "0 20px 60px oklch(0.55 0.14 45 / 0.25), 0 4px 16px oklch(0.55 0.14 45 / 0.12)",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Dash through the ghar — dodge furniture, grab coins!"
                }
              ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, oklch(0.65 0.18 45), oklch(0.58 0.22 35))",
                    color: "oklch(0.99 0 0)",
                    boxShadow: "0 6px 20px oklch(0.55 0.18 45 / 0.45), inset 0 1px 0 oklch(0.80 0.12 55 / 0.4)"
                  },
                  whileHover: {
                    scale: 1.03,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: [
                    ...
                    { key: "↑ / Space", desc: "Jump" },
                    { key: "↓", desc: "Slide" }
                  ].map(({ key, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-0.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
...
const GameScene = reactExports.lazy(() => __vitePreload(() => import("./GameScene-C5b_pSUk.js"), true ? __vite__mapDeps([0,1,2]) : void 0));
function GamePage() {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          reactExports.Suspense,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(GameScene, {})
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: gamePhase === "playing" && /* @__PURE__ */ jsxRuntimeExports.jsx(HUD, {}, "hud") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { mode: "wait", children: [
          gamePhase === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsx(StartScreen, {}, "start"),
          gamePhase === "gameover" && /* @__PURE__ */ jsxRuntimeExports.jsx(GameOver, {}, "gameover")
        ] })
      ]
    }
  );
}
const GamePage$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: GamePage
